...
var card = document.querySelector('.pokemon-card');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var rightCard = document.querySelector('.right-card');
  function parallaxEffect() {
    var sectionTop = infoSection.offsetTop;
    var sectionHeight = infoSection.offsetHeight;
    var scrollY = window.scrollY;
    var windowHeight = window.innerHeight;
    if (scrollY + windowHeight > sectionTop && scrollY < sectionTop + sectionHeight) {
      var progress = (scrollY + windowHeight - sectionTop) / windowHeight;
      ...
      var moveDistance = 100 * (1 - clampedProgress);
      leftCard.style.transform = "translateX(".concat(-moveDistance, "%)");
      rightCard.style.transform = "translateX(".concat(moveDistance, "%)");
    } else {
